...
#[inline(always)]
pub fn account_create(src: Val, dst: Val, starting_balance: Val) -> Val {
    unsafe { host_fns::account_create(src, dst, starting_balance) }
}

#[inline(always)]
pub fn account_create_trustline(acc: Val, asset: Val) -> Val {
    unsafe { host_fns::account_create_trustline(acc, asset) }
}

#[inline(always)]
pub fn account_get_balance(acc: Val, asset: Val) -> Val {
    unsafe { host_fns::account_get_balance(acc, asset) }
}
