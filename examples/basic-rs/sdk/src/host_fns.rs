...
extern "C" {
    ...
    #[link_name = "$6"]
    pub(crate) fn account_create(src_acc: Val, dst_acc: Val, starting_balance: Val) -> Val;
    #[link_name = "$7"]
    pub(crate) fn account_create_trustline(acc: Val, asset: Val) -> Val;
    #[link_name = "$8"]
    pub(crate) fn account_get_balance(acc: Val, asset: Val) -> Val;
}
